  ...
  return (
    <div>
      <div className={`fixed ${navOpen} transform transition-all duration-500  inset-0 z-[1000] bg-black opacity-70 w-full h-screen`}>
         <div className={`text-white ${navOpen} transform transition-all duration-500 delay-200 fixed justify-center flex flex-col h-full w-[80%] sm:w-[60%] bg-[#0f0715] space-y-6 z-[10000]`} >
         {
